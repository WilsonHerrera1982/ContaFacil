...
namespace ContaFacil.Controllers
{
    public class FacturaController : Controller
    {
        ...
        public FacturaController(ContableContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFactura,IdCliente,Fecha,MontoTotal,Estado,EstadoBoolean,FechaCreacion,FechaModificacion,UsuarioCreacion,UsuarioModificacion")] Factura factura)
        {
